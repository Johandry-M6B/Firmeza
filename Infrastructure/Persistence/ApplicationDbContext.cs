...
using InventoryMovement = Domain.Entities.InventoryMovement;
using Measurement = Domain.Entities.Measurement;
using PaymentSale = Domain.Entities.PaymentSale;
using Product = Domain.Entities.Product;
using Sale = Domain.Entities.Sale;
using SalesDetail = Domain.Entities.SalesDetail;
