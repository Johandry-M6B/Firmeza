...
namespace Firmeza.Web.Controllers
{
    ...
    public class MeasurementsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Abbreviation,Active")] Measurement measurement)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Abbreviation,Active")] Measurement measurement)
        {
